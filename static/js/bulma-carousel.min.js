!function(t, e) {
    ...
    return i = [function(t, e, i) {
        ...
        var n = i(2)
          ...
          , a = function(t) {
            ...
            return 1 < arguments.length && void 0 !== arguments[1] && arguments[1] && (t = window.getComputedStyle(t),
            e += parseInt(t.marginTop) + parseInt(t.marginBottom)),
            e
        }
          , h = function(t, e) {
            if (!e)
    ...
    , function(t, e, i) {
        ...
        (function(t, e, i) {
            ...
            key: "add",
            value: function(t) {
                return new o(this._x + t._x,this._y + t._y)
            }
        }, {
            key: "sub",
            value: function(t) {
            ...
            key: "max",
            value: function(t) {
                return new o(Math.max(this._x, t._x),Math.max(this._y, t._y))
            }
        }, {
            key: "equals",
            value: function(t) {
            ...
            set: function() {
                return this._x = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0,
                this
            }
        }, {
            key: "y",
            ...
            set: function() {
                return this._y = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0,
                this
            }
        }]);
        var s = o;
    ...
    , function(t, e, i) {
        ...
        i = function(t) {
            ...
            function o(t) {
                ...
                if (s.element = Object(a.c)(t) ? document.querySelector(t) : t,
                !s.element)
                    throw new Error("An invalid selector or non-DOM node has been provided.");
                s._clickEvents = ["click", "touch"];
                i = s.element.dataset ? Object.keys(s.element.dataset).filter(function(t) {
                    return Object.keys(y.a).includes(t)
                }).reduce(function(t, e) {
                    return b({}, t, (t = {},
                    i = e,
                    e = s.element.dataset[e],
                ...
                return s.options = b({}, y.a, e, i),
                s._id = Object(r.a)("slider"),
                s.onShow = s.onShow.bind(s),
                s._init(),
                s
            }
            ...
            w(o, [{
                ...
                value: function() {
                    ...
                    this._breakpoint = new l.a(this),
                    this._autoplay = new h.a(this),
                    this._navigation = new c.a(this),
                    this._pagination = new f.a(this),
                    this._infinite = new d.a(this),
                    this._loop = new u.a(this),
                ...
                value: function() {
                    var e = this;
                    this.options.vertical ? (this._ui.wrapper.style.height = Object(n.c)(this._slides[0]) * this.slidesToShow,
                    ...
                    this._wrapperWidth = Object(n.e)(this._ui.wrapper),
                    this._wrapperHeight = Object(n.c)(this._ui.wrapper),
                    this.options.vertical ? (this._slideWidth = Math.ceil(this._wrapperWidth),
                    this._containerHeight = Math.ceil(Object(n.c)(this._slides[0]) * this._slides.length),
                ...
                key: "_setHeight",
                value: function() {
                    "translate" !== this.options.effect && (this._ui.container.style.height = Object(n.c)(this._slides[this.state.index]) + "px")
                }
            }, {
                key: "_setClasses",
                value: function() {
                    var e = this;
                    this._slides.forEach(function(t) {
                        Object(n.d)(t, "is-active is-current is-slide-previous is-slide-next"),
                ...
                value: function() {
                    var i = this
                      ...
                      , s = new Array
                      , t = Object(a.c)(t) ? document.querySelectorAll(t) : Array.isArray(t) ? t : [t];
                    return [].forEach.call(t, function(t) {
                        var e;
                        void 0 === t[i.constructor.name] ? (e = new o(t,n),
                        t[i.constructor.name] = e,
                        s.push(e)) : s.push(t[i.constructor.name])
                    }),
                    s
                }
            }]),
                ...
                if (this instanceof i)
                    return (e = function(t, e) {
                        if (t)
                            return !e || "object" != typeof e && "function" != typeof e ? t : e;
                        throw new ReferenceError("this hasn't been initialised - super() hasn't been called")
                    }(this, (i.__proto__ || Object.getPrototypeOf(i)).call(this))).slider = t,
    ...
    , function(t, e, i) {
        ...
        var i = !!("ontouchstart"in window)
          ...
          , i = i || window.DocumentTouch && document instanceof DocumentTouch || navigator.maxTouchPoints
          , n = i && e ? "pointerenter" : "mouseenter"
          , s = i && e ? "pointerleave" : "mouseleave"
    }
    , function(t, e, i) {
        "use strict";
        ...
        n(r, [{
            ...
            value: function() {
                ...
                window.addEventListener("orientationchange", this[o])
            }
        }, {
            key: "_unbindEvents",
            value: function() {
                window.removeEventListener("resize", this[o]),
                window.removeEventListener("orientationchange", this[o])
            }
        }, {
            ...
            value: function() {
                ...
                try {
                    for (var n, s = this.options.breakpoints[Symbol.iterator](); !(t = (n = s.next()).done); t = !0) {
                        var o = n.value;
                        if (o.changePoint >= window.innerWidth)
                            return o
                    }
                } catch (t) {
                    e = !0,
            ...
            key: "getSlidesToShow",
            value: function() {
                return (this._currentBreakpoint || this._defaultBreakpoint).slidesToShow
            }
        }, {
            key: "getSlidesToScroll",
            value: function() {
                return (this._currentBreakpoint || this._defaultBreakpoint).slidesToScroll
            }
        }, {
            key: "apply",
            value: function() {
            ...
            value: function(t) {
                ...
                this.apply()) : this.slider._setDimensions()
            }
        }]),
        e.a = r
    }
        ...
        (function(t, e, i) {
            ...
            value: function() {
                if (this.slider.options.infinite && "translate" === this.slider.options.effect) {
                    ...
                    for (var t, e = [], i = this.slider.state.length; i > this.slider.state.length - 1 - this._infiniteCount; --i)
                        t = (this.slider.state.length * Math.floor(this._infiniteCount / this.slider.state.length) + i - 1) % this.slider.state.length,
                        e.unshift(this._cloneSlide(this.slider.slides[t], t - this.slider.state.length));
                    ...
                    this.slider.slides = [].concat(e, function(t) {
                        if (Array.isArray(t)) {
                            for (var e = 0, i = Array(t.length); e < t.length; e++)
                                i[e] = t[e];
                            return i
            ...
            value: function(t, e) {
                t = t.cloneNode(!0);
                return t.dataset.sliderIndex = e,
                t.dataset.cloned = !0,
                (t.querySelectorAll("[id]") || []).forEach(function(t) {
                    t.setAttribute("id", "")
                }),
                t
            }
    ...
    , function(t, e, i) {
        ...
        var n = function(t, e) {
            ...
            0 <= t.top && 0 <= t.left && t.bottom <= (window.innerHeight || e.clientHeight) && t.right <= (window.innerWidth || e.clientWidth)
        }
    }
    , function(t, e, i) {
        "use strict";
        ...
        (function(t, e, i) {
            ...
            value: function() {
                ...
                this._ui.next.classList.remove("is-hidden")) : (this.slider.state.next >= this.slider.state.length - this.slider.slidesToShow && !this.slider.options.centerMode || this.slider.state.next >= this.slider.state.length - 1 && this.slider.options.centerMode) && (this._ui.previous.classList.remove("is-hidden"),
    ...
    , function(t, e, i) {
        ...
        function a(t) {
            ...
            this.slider = t,
            this._clickEvents = ["click", "touch"],
            this._supportsPassive = Object(o.a)(),
    ...
    , function(t, e, i) {
        ...
        (function(t, e, i) {
            ...
            value: function(t) {
                var e;
                this._origin && (e = t.touches ? t.touches[0] : t,
    ...
    , function(t, e, i) {
        ...
        (function(t, e, i) {
            ...
            key: "apply",
            value: function(t, e) {
                this._animating && !t || ("fade" === this.options.effect ? this._animation = this._fade : this._animation = this._translate,
    ...
    , function(t, e, i) {
        ...
        (function(t, e, i) {
            ...
            value: function(t) {
                ...
                this._oldSlide && this._newSlide && (Object(n.a)(this._oldSlide, {
                    opacity: 0
                }),
                Object(n.a)(this._newSlide, {
                    opacity: 1,
                    "z-index": t ? 0 : -1
                }))
            }
            ...
            key: "onTransitionEnd",
            value: function(t) {
                "fade" === this.options.effect && (this.transitioner.isAnimating() && t.target == this._newSlide && (this._newSlide && (Object(n.a)(this._newSlide, {
                    "z-index": 0
                }),
                this._newSlide.removeEventListener("transitionend", this.onTransitionEnd.bind(this))),
                this._oldSlide) && (Object(n.a)(this._oldSlide, {
                    "z-index": -2
                }),
    ...
    , function(t, e, i) {
        ...
        (function(t, e, i) {
            ...
            key: "init",
            value: function() {
                return this._position = new o.a(this.slider.container.offsetLeft,this.slider.container.offsetTop),
                this._bindEvents(),
                this
            }
        }, {
            ...
            key: "apply",
            value: function() {
                var t, e, i, n = this, s = void 0;
                "translate" === this.options.effect && (t = this.slider.slides.filter(function(t) {
                    return t.dataset.sliderIndex == n.slider.state.next
                })[0],
                e = new o.a(t.offsetLeft,t.offsetTop),
                s = this.options.centerMode ? new o.a(Math.round(Object(r.e)(this.slider.container)),Math.round(Object(r.b)(this.slider.container))) : new o.a(Math.round(Object(r.e)(this.slider.container) - Object(r.e)(this.slider.wrapper)),Math.round(Object(r.b)(this.slider.container) - Object(r.b)(this.slider.wrapper))),
                i = new o.a(Math.min(Math.max(-1 * e.x, -1 * s.x), 0),Math.min(Math.max(-1 * e.y, -1 * s.y), 0)),
                this.options.loop && (!this.options.vertical && Math.abs(this._position.x) > s.x ? (i.x = 0,
                this.slider.state.next = 0) : this.options.vertical && Math.abs(this._position.y) > s.y && (i.y = 0,
                this.slider.state.next = 0)),
                this._position.x = i.x,
                this._position.y = i.y,
                this.options.centerMode && (this._position.x = this._position.x + this.slider.wrapperWidth / 2 - Object(r.e)(t) / 2),
                ...
                e.x > s.x) && this.slider.transitioner.end()
            }
        }, {
            key: "onTransitionEnd",
            value: function(t) {
